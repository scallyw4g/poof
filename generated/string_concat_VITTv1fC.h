// callsite
// ./include/bonsai_stdlib/src/counted_string.cpp:203:0

// def (string_concat)
// ./include/bonsai_stdlib/src/counted_string.cpp:158:0
link_internal counted_string
Concat( cs S0, cs S1, cs S2,  heap_allocator* Memory, umm ExtraChars = 0)
{
  umm TotalLength =   S0.Count +  S1.Count +  S2.Count +  ExtraChars ;
