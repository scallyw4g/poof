// callsite
// ./include/bonsai_stdlib/src/heap_allocator.h:39:0
...
link_internal b32
AreEqual(heap_allocation_block_block_array_index *Thing1, heap_allocation_block_block_array_index *Thing2)
{
  if (Thing1 && Thing2)
  {
        b32 Result = MemoryIsEqual((u8*)Thing1, (u8*)Thing2, sizeof( heap_allocation_block_block_array_index ) );
...
{
  heap_allocation_block_block_array_index Result = {Arr->BlockCount * 256};
  return Result;
}
...
{
  umm BlockIndex   = Index.Index / 256;
