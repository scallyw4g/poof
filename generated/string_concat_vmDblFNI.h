// callsite
// ./include/bonsai_stdlib/src/counted_string.cpp:213:0

// def (string_concat)
// ./include/bonsai_stdlib/src/counted_string.cpp:158:0
link_internal counted_string
Concat( cs S0, cs S1, cs S2, cs S3, cs S4, cs S5, cs S6, cs S7,  heap_allocator* Memory, umm ExtraChars = 0)
{
  umm TotalLength =   S0.Count +  S1.Count +  S2.Count +  S3.Count +  S4.Count +  S5.Count +  S6.Count +  S7.Count +  ExtraChars ;
