// callsite
// ./include/bonsai_stdlib/src/framebuffer.cpp:2:0

// def (block_array)
// ./include/bonsai_stdlib/src/poof_functions.h:2753:0
...
link_internal b32
AreEqual(rtt_framebuffer_block_array_index *Thing1, rtt_framebuffer_block_array_index *Thing2)
{
  if (Thing1 && Thing2)
  {
        b32 Result = MemoryIsEqual((u8*)Thing1, (u8*)Thing2, sizeof( rtt_framebuffer_block_array_index ) );
