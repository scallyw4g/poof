// ./include/bonsai_stdlib/src/platform/win32/win32_platform.cpp:410:0
...
BindKeyupToInput( VK_OEM_PERIOD, Dot);
...
BindKeyupToInput( 0x32, N2);

BindKeyupToInput( 0x33, N3);

BindKeyupToInput( 0x34, N4);

BindKeyupToInput( 0x35, N5);

BindKeyupToInput( 0x36, N6);

BindKeyupToInput( 0x37, N7);

BindKeyupToInput( 0x38, N8);

BindKeyupToInput( 0x39, N9);
